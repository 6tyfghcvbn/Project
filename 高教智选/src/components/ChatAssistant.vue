  ...
  <div class="chat-container">
    ...
    <div class="chat-input-area">
      <div class="chat-input-row">
        ...
        <button class="send-btn" @click="sendMessage" :disabled="!inputMessage.trim() || isProcessing">发送</button>
      </div>
...
const sendMessage = async () => {
  ...
  try {
        ...
        if (line.startsWith('data: ')) {
          try {
            ...
            if (data.type === 'message') {
              ...
              messages.value[assistantIndex].content = `抱歉，出现错误：${data.content}`
              break
    ...
    if (messages.value[assistantIndex]) {
      messages.value[assistantIndex].content = '网络错误，请稍后重试'
    }
  } finally {
